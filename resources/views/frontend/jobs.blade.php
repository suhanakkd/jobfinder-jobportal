      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        ...
        <ul class="alig-div navbar-nav ms-auto" style="font-size: 12px;">
          ...
          Sysbreeze Technologies
            <div class="ps-4" style="font-size: 10px;">owner:shakkirpp@gmail.com</div>
          </div></li></a>
          <!-- <a class="nav-link " href="#" tabindex="-1" aria-disabled="true">
            ...
            <a href="#" class="nav-link d-flex align-items-center text-decoration-none" id="dropdownUser1" data-bs-toggle="dropdown" aria-expanded="false">
                ...
                <img src="{{URL::to('/')}}/frontend/image/kids.jpg" alt="hugenerd" width="30" height="30" class="rounded-circle">
                <span class="d-none d-sm-inline mx-1">shakkirpp@gmail.com</span></div>
                ...
                <div class="d-flex flex-column justify-content-center align-items-center post-division px-5">
                  ...
                  <div class="bg-white  w-100 py-5 px-5 rounded mb-5 d-flex">
                    ...
                    <div class="col-lg-4 me-4">
                        <select class="form-select p-3" aria-label="Default select example" name="category">
                            <option selected>Job Category</option>
                            @foreach($jobpost as $post)
                            
                            <option value="{{$post->id}}">{{$post->job_tittle}}</option>
...
<div class="bg-white  w-100 py-5 px-5 rounded mb-5 d-flex">
    <table class="table">
        ...
        @foreach($jobpost as $post) 
          <tr>
            <td> <input type="checkbox" class="form-check-input p-3 mt-4" id="exampleCheck1"></td>

            <td>
           
            
                    <h5 class="text-primary">{{$post->job_tittle}}</h5>
                    
                   
                    <span class="text-secondary"> @foreach($post->data2 as $district){{$district->name}} @endforeach,@foreach($post->data1 as $state){{$state->name}}@endforeach</span><br>
                   
                    <span class="text-secondary">Posted-Date:{{$post->posting_date}}</span>
              
           </td>
           <td><div class="btn-group mt-4 px-4" role="group" aria-label="Basic outlined example">
           
         @if($post->status==0)
        
                <a href="{{URL::to('topaused/'.$post->id)}}" class=""><button type="button"  class="btn btn-outline-warning" >paused</button></a>
        
         @else($post->status==1)
         
                <a href="{{URL::to('toactivate/'.$post->id)}}" class=""><button type="button" class="btn btn-outline-success" >Active</button></a>
         
                @endif  
                <a href="{{URL::to('postdelete/'.$post->id)}}" class=""><button type="button" class="btn btn-outline-danger" >Delete</button></a> 
...
@endforeach
            <!-- <tr>
                ...
                <td>
                        ...
                        <h5 class="text-primary">Flutter Developer</h5>
                        <span class="text-secondary">Kozhikode,kerala</span><br>
                        <span class="text-secondary">Posted-Date:17 april 2023</span>
                
            </td>
                <td><select class="form-select mt-4" aria-label="Default select example">
