...
<!-- sidebar end -->
        ...
        <form action="{{URL('job_tittle')}}" method="POST">
             {{ csrf_field() }}
        <div class="d-flex flex-column justify-content-center align-items-center post-division px-5">
          ...
          <div class="bg-white  w-100 py-5 px-5 rounded mb-5 d-flex">
            ...
            <div class="col-lg-4 me-4">
                <select class="form-select p-3" aria-label="Default select example" name="tittle">
                    <option selected>Job Tittle</option>
                   
                    @foreach($tittle as $tittle)
                    <option value="{{$tittle->id}}">{{$tittle->job_tittle}}</option>
                    @endforeach
...
<!-- table start -->
<div class="bg-white  w-100 py-5 px-5 rounded mb-5 d-flex mt-5">
    <table class="table">
        <thead>
          <tr>
        ...
        @foreach($candidate as $cand)
          <tr>
            ...
            @foreach($cand->profile as $profile)
                    <h5 class="text-primary">{{$profile->name}}</h5>
                   
                    @foreach($cand->job as $tittle)
                    <span class="text-secondary">{{$tittle->job_tittle}}</span><br>
                    @endforeach
                        <!-- <span class="text-secondary">Awaiting Review:</span> -->
           </td>
         <td> <a href="{{URL::to('/frontend/cv/'.$profile->id)}}"><button type="button" class="btn btn-primary mt-4">VIEW</button></a></td>
         @endforeach
            <td><div class="btn-group mt-4 px-4" role="group" aria-label="Basic outlined example">
                <a href="" class=""><button type="button" class="btn btn-outline-primary"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-check-circle" viewBox="0 0 16 16">
                    <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"/>
                    <path d="M10.97 4.97a.235.235 0 0 0-.02.022L7.477 9.417 5.384 7.323a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-1.071-1.05z"/>
                  </svg></button></a>
                  <a href=""><button type="button" class="btn btn-outline-primary"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-x" viewBox="0 0 16 16">
                    <path d="M6.146 6.146a.5.5 0 0 1 .708 0L8 7.293l1.146-1.147a.5.5 0 1 1 .708.708L8.707 8l1.147 1.146a.5.5 0 0 1-.708.708L8 8.707 6.854 9.854a.5.5 0 0 1-.708-.708L7.293 8 6.146 6.854a.5.5 0 0 1 0-.708z"/>
                    <path d="M4 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H4zm0 1h8a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1z"/>
                  </svg></button></a>
                  <a href=""><button type="button" class="btn btn-outline-primary"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-question-circle-fill" viewBox="0 0 16 16">
                    <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM5.496 6.033h.825c.138 0 .248-.113.266-.25.09-.656.54-1.134 1.342-1.134.686 0 1.314.343 1.314 1.168 0 .635-.374.927-.965 1.371-.673.489-1.206 1.06-1.168 1.987l.003.217a.25.25 0 0 0 .25.246h.811a.25.25 0 0 0 .25-.25v-.105c0-.718.273-.927 1.01-1.486.609-.463 1.244-.977 1.244-2.056 0-1.511-1.276-2.241-2.673-2.241-1.267 0-2.655.59-2.75 2.286a.237.237 0 0 0 .241.247zm2.325 6.443c.61 0 1.029-.394 1.029-.927 0-.552-.42-.94-1.029-.94-.584 0-1.009.388-1.009.94 0 .533.425.927 1.01.927z"/>
                  </svg></button></a>
              </div></td>
          </tr>
