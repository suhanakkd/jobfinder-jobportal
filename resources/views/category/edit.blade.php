                ...
                <div class="card-body">
                        ...
                        <div class="col-md-6">
                           ...
                           <div class="col-md-6 heading">
                             <a href="{{URL::to('category/index')}}" class="backicon"><i class="mdi mdi-backburger"></i></a>
                        </div>
                        <div class="col-md-6">
                        </div>
                    </div>
                  ...
                  <form class="form-sample"  action="{{url('updatecategory')}}" method="post" enctype="multipart/form-data">
                          {{csrf_field()}}
                    <div class="row">
